...
class TestFileStorageInstantiation(unittest.TestCase):
    ...
    def test_FileStorage_instantiation_no_args(self) -> None:
        self.assertEqual(type(FileStorage()), FileStorage)

    def test_FileStorage_instantiation_with_arg(self) -> None:
        with self.assertRaises(TypeError):
            FileStorage(None)

    def test_FileStorage_file_path_is_private_str(self) -> None:
        self.assertEqual(str, type(FileStorage._FileStorage__file_path))

    def testFileStorage_objects_is_private_dict(self) -> None:
